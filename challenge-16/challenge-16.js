(function () {
    ...
    */
    ...
    var fullName = 'antonio-edson-moreno-junior';
    ...
    */
    console.log('\nMeus amigos:');
    var friends = ['Junior', 'Claudio', 'Ledir', 'Josi', 'Ana'];

    var lastArr = friends.pop();    
    friends = friends.join(', ') + ' e ' + lastArr;
    ...
    */
    ...
    myName.toLowerCase().split('').map(function(item, index){

       index % 2 === 0 ? nameMod += item.toUpperCase() : nameMod += item;
